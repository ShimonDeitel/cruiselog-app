...
struct SettingsView: View {
    ...
    @AppStorage("cruiselog_showNotes") private var showNotes: Bool = true
    @AppStorage("cruiselog_compactList") private var compactList: Bool = false
    ...
    var body: some View {
        NavigationStack {
            Form {
                ...
                Section("About") {
                    Link("Privacy Policy", destination: URL(string: "https://shimondeitel.github.io/cruiselog-app/privacy.html")!)
                        .accessibilityIdentifier("settingsPrivacyLink")
                    Link("Terms of Use", destination: URL(string: "https://shimondeitel.github.io/cruiselog-app/terms.html")!)
